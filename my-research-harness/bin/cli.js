...
// Generated by metaharness — the `my-research-harness` CLI entry point.
//
// This is plain ESM JavaScript on purpose: it runs as-is via `npx my-research-harness`
...
// "bin" + "files" fields in package.json), so `npx my-research-harness` works the moment
...
/** `my-research-harness init` — boot the kernel + host adapter and report status. */
async function init() {
...
/** `my-research-harness doctor` — verify the install end-to-end (kernel + host resolve). */
