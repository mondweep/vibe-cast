---
plugin: ruflo-graph-intelligence
plugin_id: ruflo-graph-intelligence
...
Measured surface area: 0 commands, 0 agents, 0 skills, no MCP server, no hooks (v0.1.0-alpha.1).
