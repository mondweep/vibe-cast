...
plugin_id: plugin_01VyNDLNYUZHHyKf7A691D7V
...
> Search across company tools — email, chat, documents, wikis — in one place.

## Dependencies

Requires **email, chat, document and wiki connectors**. Confirm each is authorised before testing; if any is missing, set `status: blocked` and record which one.
