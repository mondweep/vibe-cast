---
plugin: bio-research
plugin_id: plugin_01DZdK2sP1iWnY1hRYRcFc9W
...
> Preclinical research tools and databases: literature search, genomics analysis, target prioritization.

## Dependencies

Requires **literature/genomics MCP servers**. Confirm each is authorised before testing; if any is missing, set `status: blocked` and record which one.
