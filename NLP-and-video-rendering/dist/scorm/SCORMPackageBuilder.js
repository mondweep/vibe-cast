...
exports.SCORMPackageBuilder = void 0;
const archiver_1 = __importDefault(require("archiver"));
const fs = __importStar(require("fs"));
const path = __importStar(require("path"));
class SCORMPackageBuilder {
    config;
    constructor(config) {
        this.config = config;
    }
    async build(enrichedContent, interactiveContent, videoContent, outputPath) {
    ...
    createManifest(enrichedContent, interactiveContent) {
...
<manifest identifier="${manifest.identifier}" version="${manifest.version}"
  ...
  <resources>
    ...
    createPlayerHTML(enrichedContent, interactiveContent) {
        return `<!DOCTYPE html>
<html lang="en">
<head>
  <meta charset="UTF-8">
...
function saveProgress(location) {
  if (API_1484_11) {
    ...
    async packageFiles(manifest, playerHTML, scormAPI, outputPath, enrichedContent, interactiveContent, videoContent) {
...
exports.SCORMPackageBuilder = SCORMPackageBuilder;
//# sourceMappingURL=SCORMPackageBuilder.js.map