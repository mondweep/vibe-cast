...
exports.handler = async (event, context) => {
    ...
    try {
        ...
        return {
            ...
            body: JSON.stringify({
                ...
                error: blobError.message || blobError.toString()
            })
        };
    }
    ...
    try {
        ...
        try {
            ...
            console.log(`Error state stored for job ${jobId}`);
        } catch (storeErr) {
            console.error('Failed to store error state:', storeErr);
            console.error('Store error stack:', storeErr.stack);
        }
