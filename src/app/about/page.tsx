            ...
            <div className="flex items-start gap-4">
              ...
              <div className="flex-1">
                ...
                <p className="text-primary text-sm font-mono mb-3">
                  AWS Networking Practitioner & Course Author
                </p>
                <p className="text-muted-foreground text-sm leading-relaxed mb-4">
                  ...
                  focused on agentic AI and automation. This course was designed and built to upskill students, teachers, and practitioners — drawing on
                  real-world cloud and networking experience and a passion for making advanced AWS concepts
