...
export const periodSummaryFixture: PeriodSummaryViewModel = {
  ...
  replacement: {
    ...
    /*
     * Deliberately shaped like the real register rather than trimmed to three
     * rows. Two properties of the live data are load-bearing for the Cost
     * Explorer and were absent when this fixture was a stub:
     *
     *   - It is LONG. Twenty assumptions is a chart nobody scrolls to the end
     *     of, which is why the sensitivity chart truncates and says so. A
     *     three-row fixture cannot exercise a truncation notice.
     *   - Labels REPEAT across figures. "GST uplift" is four separate
     *     assumptions and "Share of the SDRF ceiling actually needed" is four
     *     more — the same judgement made for different lines. On a chart axis
     *     those are identical bars of different lengths, so they have to be
     *     disambiguated, and a fixture with unique labels would let that
     *     regress silently.
     */
    assumptionRegister: [
      {
        label: 'Share of the SDRF ceiling actually needed',
        affects: 'Schools, anganwadi, water supply, power and other assets',
        value: 0.6,
        unit: 'share',
        low: 0.3,
        high: 1,
        reason: 'The SDRF figure is a CEILING per damaged unit, not a flat payment.',
        spread: 3.33,
        swing: 533_000_000,
      },
      {
        ...
        low: 25,
        high: 46.6,
        reason: 'PMAY-G statutory minimum, to the NSS 76th round rural average.',
        spread: 1.86,
        swing: 438_000_000,
      },
      {
        label: 'Deposit to remove per homestead',
        affects: 'Homestead silt clearance',
        value: 12,
        unit: 'm³',
        low: 5,
        high: 25,
        reason: 'Area × depth: the dwelling footprint plus its working yard, at 150 mm.',
        spread: 5,
        swing: 336_000_000,
      },
      {
      ...
      },
      {
        ...
        low: 0.35,
        high: 0.6,
        reason: 'A 30 m² plan has roughly 22 m of external wall at 2.75 m and 230 mm.',
        spread: 1.71,
        swing: 256_000_000,
      },
      {
        label: 'Share rendered uncultivable by sand casting or channel change',
        affects: 'Land lost to sand casting or channel change',
        value: 0.03,
        unit: 'share',
        low: 0.01,
        high: 0.08,
        reason: 'A small fraction of a small fraction; checked against Dhemaji land use.',
        spread: 8,
        swing: 186_000_000,
      },
      {
        ...
        low: 1.25,
        high: 1.55,
        reason: 'The priced items buy a shell with no openings, wiring, water or paint.',
        spread: 1.24,
        swing: 135_000_000,
      },
      {
        label: 'Plinth raise above natural ground',
        affects: 'Raised plinth',
        value: 0.9,
        unit: 'm',
        low: 0.6,
        high: 1.5,
        reason: 'The correct height is the site’s highest flood level, which is not reported.',
        spread: 2.5,
        swing: 123_000_000,
      },
      {
        ...
        low: 25,
        high: 46.6,
        reason: 'Held equal to the reference dwelling by a test.',
        spread: 1.86,
        swing: 110_000_000,
      },
      {
        ...
        low: 0.4,
        high: 2.5,
        reason: 'MEASURED FROM THE ARCHIVE: 200 of 645 road records state a length.',
        spread: 6.25,
        swing: 82_000_000,
      },
      {
      ...
      {
        label: 'Share of the SDRF ceiling actually needed',
        affects: 'Embankments breached and affected',
        value: 0.6,
        unit: 'share',
        low: 0.3,
        high: 1,
